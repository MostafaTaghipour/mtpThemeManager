...
extension ThemeManager {
                        ...
                        buttonStyle: ButtonStyle)
    {
        ...
        setNavigationBarStyle(style: navigationBarStyle)
        setTabBarStyle(style: tabBarStyle)
        setToolbarStyle(style: toolbarStyle)
        setStatusBarStyle(style: statusBarStyle)
        setKeyboardStyle(style: keyboardStyle)
        setTextFieldStyle(style: textFieldStyle)
        setSearchBarStyle(style: searchBarStyle)
        setTextViewStyle(style: textViewStyle)
        setActivityIndicatorViewStyle(style: activityIndicatorViewStyle)
        setSliderStyle(style: sliderStyle)
        setSwitchStyle(style: switchStyle)
        setStepperStyle(style: stepperStyle)
        setScrollViewStyle(style: scrollViewStyle)
        setSegmentedControlStyle(style: segmentedControlStyle)
        setPageControlStyle(style: pageControlStyle)
        setProgressViewStyle(style: progressViewStyle)
    }
